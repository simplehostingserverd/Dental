	...
	return (
		<div className="flex h-full w-64 flex-col dashboard-sidebar">
			...
			<div className="flex items-center border-slate-700 border-b px-6 py-6">
				...
				<span className="ml-2 font-bold text-xl text-white">Cognident</span>
			</div>
			...
			<div className="mt-auto border-slate-700 border-t p-4">
				<div className="rounded-xl bg-gradient-to-r from-indigo-600/20 to-purple-600/20 p-4 backdrop-blur-sm border border-indigo-500/20">
					<div className="flex items-center">
						<Bot className="h-5 w-5 text-indigo-400" />
						<h3 className="ml-2 font-semibold text-white text-sm">
							AI Assistant
						</h3>
					</div>
					...
					<button
						type="button"
						className="mt-3 w-full dashboard-button text-sm py-2"
					>
						Ask AI
					</button>
				</div>
