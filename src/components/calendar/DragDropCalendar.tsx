		...
		>
			<div className="space-y-4">
							...
							<div className="grid grid-cols-1">
								...
								<div className="border-gray-200 border-b p-4">
									<div className="grid grid-cols-12 gap-4">
										<div className="col-span-2 font-medium text-gray-500 text-sm">
											Time
										</div>
												...
												<div className="grid grid-cols-12 gap-4 p-4 hover:bg-gray-50">
													...
													<div className="col-span-10 space-y-2">
														...
														{slot.appointments.length === 0 && (
															<div className="flex h-12 items-center justify-center rounded-lg border-2 border-gray-200 border-dashed text-gray-400 hover:border-gray-300 hover:text-gray-500">
				...
				{view === "week" && (
					<Card>
						<CardContent className="p-0">
							<div className="grid grid-cols-8 border-gray-200 border-b">
								{/* Time column header */}
								<div className="border-gray-200 border-r p-4 font-medium text-gray-500 text-sm">
									Time
								</div>
								{/* Day headers */}
								{weekDates.map((date, index) => (
									<div
										key={index}
										className="border-gray-200 border-r p-4 text-center last:border-r-0"
									>
							...
							<div className="divide-y divide-gray-100">
								{timeSlots.map((slot) => (
									<div key={slot.time} className="grid grid-cols-8">
										{/* Time label */}
										<div className="border-gray-200 border-r p-4 text-gray-500 text-sm">
											{slot.time}
										</div>
										{/* Day columns */}
										{weekDates.map((date, dayIndex) => {
											...
											return (
												<DroppableTimeSlot
													...
													onNewAppointment={onNewAppointment}
												>
													<div className="min-h-[60px] border-gray-200 border-r p-2 last:border-r-0 hover:bg-gray-50">
							...
							<div className="grid grid-cols-7 border-gray-200 border-b">
								{["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
									(day) => (
										<div
											key={day}
											className="border-gray-200 border-r p-4 text-center font-medium text-gray-500 text-sm last:border-r-0"
										>
											{day}
										</div>
									),
							...
							<div className="grid grid-cols-7">
								{Array.from({ length: 42 }, (_, i) => {
									...
									return (
										<div
											key={i}
											className={`min-h-[120px] border-gray-200 border-r border-b p-2 last:border-r-0 ${
												isCurrentMonth
										...
										>
											...
											<div className="space-y-1">
												{dayAppointments.slice(0, 3).map((appointment) => (
													<div
														key={appointment.id}
														className={`cursor-pointer truncate rounded p-1 text-xs ${getStatusColor(appointment.status)}`}
