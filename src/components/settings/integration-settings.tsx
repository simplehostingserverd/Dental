...
import { IntegrationManager, INTEGRATION_PROVIDERS, type IntegrationConfig } from "@/lib/integrations/integration-manager";
...
function IntegrationForm({ providerId, practiceId, onSave }: IntegrationFormProps) {
...
export function IntegrationSettings({ practiceId }: IntegrationSettingsProps) {
	...
	const serviceProviders = Object.entries(SERVICE_LABELS).map(([service, label]) => ({
		service,
		label,
	...
	return (
		<div className="space-y-6">
			<div>
				<h2 className="text-2xl font-bold">3rd Party Integrations</h2>
				<p className="text-gray-600">
					Configure external services for VoIP calling, SMS messaging, email, and translation.
				</p>
			</div>
