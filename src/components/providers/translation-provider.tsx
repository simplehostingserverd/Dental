...
export function LanguageSwitcher() {
  const { currentLanguage, setLanguage, supportedLanguages, isEnabled } = useTranslation();
  ...
  return (
    <div className="relative">
      <select
        ...
        className="rounded-md border border-gray-600 bg-gray-800 px-3 py-2 text-white text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
