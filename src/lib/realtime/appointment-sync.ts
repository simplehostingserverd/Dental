...
export function useAppointmentSync(options: AppointmentSyncOptions = {}) {
	...
	const syncAppointmentCreate = useCallback(
		(appointment: Appointment) => {
			setSyncStatus("syncing");
	...
	const syncAppointmentUpdate = useCallback(
		(appointment: Appointment) => {
			setSyncStatus("syncing");
	...
	const syncAppointmentDelete = useCallback(
		(appointmentId: string, appointment: Appointment) => {
			setSyncStatus("syncing");
