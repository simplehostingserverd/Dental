...
export default function CustomDomainOnboarding() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
			{/* Premium Header */}
			<header className="border-purple-800/30 border-b bg-black/20 backdrop-blur-xl">
			...
			<div className="container mx-auto px-6 py-12">
							...
							<div key={step.id} className="flex items-center">
								<div className="flex flex-col items-center">
									...
									<div className="mt-4 text-center">
										<p
											className={`font-semibold ${step.id <= currentStep ? "text-white" : "text-gray-400"}`}
										>
											{step.title}
										</p>
								...
								{index < steps.length - 1 && (
									<div
										className={`mx-8 h-1 w-24 rounded-full transition-all duration-500 ${
				...
				<div className="mx-auto max-w-4xl">
					<div className="rounded-3xl border border-purple-800/30 bg-black/40 p-8 shadow-2xl backdrop-blur-xl">
						{currentStep === 1 && (
							<div className="space-y-8">
								<div className="text-center">
									...
									<p className="text-purple-300 text-xl">
										Transform your practice with a fully branded dental
										management platform
									</p>
								</div>
								...
								<div className="space-y-6">
									<div>
										<label className="mb-3 block font-semibold text-lg text-white">
										...
										<div className="relative">
											...
											/>
											<Globe className="absolute top-4 right-4 h-6 w-6 text-purple-400" />
										</div>
									</div>

									<div className="rounded-xl border border-purple-700/30 bg-purple-900/20 p-6">
									...
									<button
										...
										className="w-full rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-4 font-bold text-lg text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl disabled:cursor-not-allowed disabled:opacity-50"
									>
										{isValidating ? (
							...
							<div className="space-y-8">
								...
								<div className="grid grid-cols-1 gap-6 md:grid-cols-3">
									{[
										...
										<div
											key={index}
											className="rounded-xl border border-purple-700/30 bg-purple-900/20 p-6 text-center"
										>
											<div
								...
								<button
									...
									className="w-full rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-4 font-bold text-lg text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl"
								>
				...
				<div className="mt-12 text-center">
					<p className="mb-4 text-purple-300">
						Need assistance with your custom domain setup?
					</p>
					<Link
