...
export default function MexicoLandingPage() {
	...
	const features = [
		{
			...
			description:
				"Sistema avanzado de citas con recordatorios automáticos por SMS y WhatsApp",
		},
		{
			icon: Users,
			title: "Expedientes Digitales",
			description:
				"Historiales médicos completos con radiografías y fotografías dentales",
		},
		{
			icon: CreditCard,
			title: "Facturación CFDI",
			description:
				"Facturación electrónica automática conforme al SAT mexicano",
		},
		{
			icon: Shield,
			title: "Seguridad HIPAA",
			description:
				"Protección total de datos médicos con encriptación de nivel bancario",
		},
		{
			icon: Stethoscope,
			title: "Odontograma Digital",
			description:
				"Charting dental interactivo con planes de tratamiento detallados",
		},
		{
			icon: Phone,
			title: "Comunicación Multicanal",
			description:
				"SMS, WhatsApp, email y llamadas integradas en una sola plataforma",
		},
	];
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-red-50">
			...
			<section className="relative py-20">
				...
				<div className="absolute inset-0 opacity-10">
					...
					>
						...
						<text x="410" y="355" className="fill-gray-700 font-medium text-sm">
							CDMX
						</text>
						<circle cx="300" cy="320" r="6" fill="#059669" />
						<text x="310" y="325" className="fill-gray-600 text-xs">
							Guadalajara
						</text>
						<circle cx="450" cy="280" r="6" fill="#059669" />
						<text x="460" y="285" className="fill-gray-600 text-xs">
							Monterrey
						</text>
						<circle cx="420" cy="330" r="5" fill="#059669" />
						<text x="430" y="335" className="fill-gray-600 text-xs">
							Puebla
						</text>
					</svg>
				</div>
				...
				<div className="container relative mx-auto px-4 text-center">
					<div className="mx-auto max-w-4xl">
						...
						<p className="mb-8 text-gray-600 text-xl">
							Más de 300 clínicas dentales en México confían en Cognident para
							gestionar sus pacientes, citas, facturación y expedientes médicos
							digitales.
						</p>
						<div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
							<Link href="/es/auth/signup">
								<Button
									size="lg"
									className="bg-gradient-to-r from-green-600 to-red-600 text-white"
								>
			...
			<section className="bg-gray-50 py-16">
				<div className="container mx-auto px-4">
					<div className="mb-12 text-center">
						...
						<p className="text-gray-600">
							Sistema completo adaptado a las necesidades del sector dental
							mexicano
						</p>
					</div>
			...
			{/* CTA Section */}
			<section className="bg-gradient-to-r from-green-600 to-red-600 py-16">
					...
					<div className="grid grid-cols-1 gap-8 md:grid-cols-4">
						<div>
							<div className="mb-4 flex items-center space-x-3">
								...
								<span className="font-bold text-xl">Cognident México</span>
							</div>
