...
export default function SpanishWhatsAppPage() {
	...
	const messageTemplates = [
		...
		},
		{
			...
			type: "payment",
			content:
				"Estimado/a {nombre}, tienes un pago pendiente de ${monto} MXN con vencimiento el {fecha}. 💳",
		},
		{
			id: 4,
			...
			type: "followUp",
			content:
				"Hola {nombre}, ¿cómo te sientes después de tu {tratamiento}? Si tienes alguna molestia, no dudes en contactarnos. 🩺",
		},
	];
