...
const translations = {
	...
	subtitle: "Gestiona las comunicaciones de WhatsApp con pacientes",
...
export default function SpanishWhatsAppPage() {
	...
	// Mock data for WhatsApp communications
	const whatsappStats = [
		{
	...
	const messageTemplates = [
		...
		},
		{
			...
			type: "payment",
			content: "Estimado/a {nombre}, tienes un pago pendiente de ${monto} MXN con vencimiento el {fecha}. 💳"
		},
		{
			id: 4,
			name: "Seguimiento Post-Tratamiento",
			type: "followUp",
			content: "Hola {nombre}, ¿cómo te sientes después de tu {tratamiento}? Si tienes alguna molestia, no dudes en contactarnos. 🩺"
		}
	];
					...
					<div className="lg:col-span-2">
						<Tabs defaultValue="history" className="w-full">
							...
							<TabsContent value="history">
								<Card className="border-gray-700 bg-gray-800">
									<CardHeader>
										<CardTitle className="text-white">Mensajes Recientes de WhatsApp</CardTitle>
									</CardHeader>
									<CardContent>
														...
														<div className="flex-1">
															...
															{message.response && (
																<div className="mt-2 rounded bg-gray-800 p-2">
																	<p className="text-green-400 text-sm">Respuesta: {message.response}</p>
																</div>
															)}
														</div>
							...
							<TabsContent value="templates">
								<Card className="border-gray-700 bg-gray-800">
									<CardHeader>
										<CardTitle className="text-white">Plantillas de WhatsApp</CardTitle>
									</CardHeader>
									<CardContent>
