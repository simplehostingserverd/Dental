...
export default function SpanishCheckInPage() {
	...
	const waitingPatients = appointments.filter(
		(a) => a.status === "waiting" || a.status === "arrived",
	);
								...
								<div className="flex items-center justify-between">
									...
									<div className="relative">
										...
										<Input
											...
											className="w-64 border-gray-600 bg-gray-700 pl-10 text-white placeholder-gray-400"
										/>
									</div>
								</div>
							</CardHeader>
												...
												<div className="flex flex-col space-y-2">
													...
													{appointment.status === "arrived" && (
														<Button
															size="sm"
															onClick={() =>
																handleStatusUpdate(appointment.id, "waiting")
															}
															className="bg-yellow-600 hover:bg-yellow-700"
														>
															<Clock className="mr-2 h-4 w-4" />A Sala de Espera
														</Button>
													)}
													{appointment.status === "waiting" && (
														<Button
							...
							<CardContent>
								<div className="space-y-3">
									...
									<div className="flex justify-between">
										...
										<span className="font-medium text-white">
											{
												appointments.filter((a) => a.status === "inTreatment")
													.length
											}
										</span>
									</div>
