			...
			<div className="relative hidden lg:flex lg:w-1/2">
				...
				<div className="relative z-10 flex flex-col justify-center p-12 text-gray-900">
					<div className="max-w-md">
						<h1 className="mb-4 font-bold text-4xl">Dentist Dashboard</h1>

						<p className="mb-8 text-gray-200 text-xl">
							Manage your practice with comprehensive tools for patient care,
						...
						<div className="space-y-6">
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-gray-300">
										Complete overview of appointments, patients, and practice
										performance
									</p>
								</div>
							</div>
							...
							<div className="flex items-start">
								...
								<div>
									...
									<p className="text-gray-300">
										Detailed insights into practice performance and growth
										opportunities
									</p>
								</div>
							</div>
