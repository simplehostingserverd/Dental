...
const CreatePostSchema = z.object({
  ...
  platforms: z.array(z.enum(["facebook", "instagram", "tiktok", "x", "linkedin", "youtube", "bluesky", "reddit", "pinterest"])),
  scheduledFor: z.string().datetime().optional(),
  imageUrl: z.string().url().optional(),
  hashtags: z.array(z.string()).default([]),
  category: z.enum(["educational", "promotional", "testimonial", "seasonal", "general"]).default("general"),
});
...
let posts: any[] = [
  ...
  {
    id: "2",
    content: "✨ Transform your smile with our professional teeth whitening service! Results in just one visit. Call us today! #TeethWhitening #SmileMakeover",
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newPost = {
      ...
      engagement: { likes: 0, comments: 0, shares: 0, views: 0, reposts: 0, saves: 0 },
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    if (!validatedData.scheduledFor) {
      ...
      console.log(`Posting to platforms: ${validatedData.platforms.join(", ")}`);
