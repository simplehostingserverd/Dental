...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      practiceLogins: [
        { role: "ADMIN", email: "admin@dentalcloud.com", password: "Admin123!" },
        { role: "DOCTOR", email: "doctor@dentalcloud.com", password: "Doctor123!" },
        { role: "HYGIENIST", email: "hygienist@dentalcloud.com", password: "Hygienist123!" },
        { role: "STAFF", email: "staff@dentalcloud.com", password: "Staff123!" },
        { role: "RECEPTIONIST", email: "receptionist@dentalcloud.com", password: "Reception123!" },
      ],
      patientLogins: [
