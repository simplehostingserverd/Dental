	...
	return (
		<div className="min-h-screen bg-gray-50">
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div className="flex h-16 items-center justify-between">
						<div className="flex items-center">
							...
							<h1 className="font-bold text-xl text-gray-900">DentalExpresso</h1>
						</div>
						<div className="flex items-center space-x-4">
							...
							<button
								...
								className="flex items-center space-x-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 hover:bg-gray-50"
								title="Logout"
							>
			...
			<main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
				<div className="mb-8">
					<h2 className="font-bold text-2xl text-gray-900">Patient Dashboard</h2>
					<p className="mt-1 text-gray-600">
						Manage your appointments, view treatment history, and communicate with your dental team.
					</p>
				</div>
				...
				<div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
					<div className="rounded-lg bg-white p-6 shadow-sm">
						<div className="flex items-center">
							...
							<div className="ml-4">
								...
								<p className="text-gray-500 text-sm">Schedule your next visit</p>
							</div>
						</div>
					...
					<div className="rounded-lg bg-white p-6 shadow-sm">
						...
						<Link href="/patient/history">
							<button className="mt-4 w-full rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700">
								View History
							</button>
						</Link>
					</div>
					...
					<div className="rounded-lg bg-white p-6 shadow-sm">
						<div className="flex items-center">
							...
							<div className="ml-4">
								...
								<p className="text-gray-500 text-sm">Contact your dental team</p>
							</div>
						</div>
						<Link href="/patient/messages">
							<button className="mt-4 w-full rounded-md bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700">
								Send Message
							</button>
						</Link>
					</div>
				...
				<div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
							...
							<div className="space-y-4">
								{patient.appointments.length > 0 ? (
									patient.appointments.map((appointment) => (
										<div key={appointment.id} className="flex items-center rounded-lg border border-gray-200 p-4">
											<div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100">
												<Calendar className="h-6 w-6 text-blue-600" />
											</div>
									...
									<div className="flex items-center justify-center py-8">
										<div className="text-center">
											...
											<h4 className="mt-2 font-medium text-gray-900">No upcoming appointments</h4>
											<p className="text-gray-500 text-sm">Book your next appointment to maintain your oral health</p>
											<Link href="/patient/appointments/book">
					...
					<div className="space-y-6">
						...
						<div className="rounded-lg bg-white p-6 shadow-sm">
							<div className="mb-4 flex items-center justify-between">
								<h3 className="font-semibold text-lg text-gray-900">Recent Messages</h3>
								<button className="text-blue-600 text-sm hover:text-blue-500">
									View All
								</button>
							</div>
						...
						{/* Quick Stats */}
						<div className="rounded-lg bg-white p-6 shadow-sm">
							<h3 className="mb-4 font-semibold text-lg text-gray-900">Your Stats</h3>
							<div className="space-y-4">
								...
								<div className="flex items-center justify-between">
									...
									<span className="font-medium text-gray-900 text-sm">{stats.totalAppointments}</span>
								</div>
							</div>
						</div>
					</div>
