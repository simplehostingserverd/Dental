				...
				<Card>
					...
					<CardContent>
						<div className="flex items-center space-x-2">
							...
							<span className="font-bold text-2xl">{stats.confirmed || 0}</span>
						</div>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent>
						<div className="flex items-center space-x-2">
							...
							<span className="font-bold text-2xl">{stats.pending || 0}</span>
						</div>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent>
						<div className="flex items-center space-x-2">
							...
							<span className="font-bold text-2xl">{stats.completed || 0}</span>
						</div>
					</CardContent>
				</Card>
			</div>
